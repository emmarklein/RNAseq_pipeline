...
This repository includes everything you need for genome mapping. Raw FASTQ files serve as input and undergo genome mapping to a reference. This tutorial includes T2T and GRCh38 reference.
